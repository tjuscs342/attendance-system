...
public class sickApplyTest {
    ...
    UserDAO userDAO;
    @Mock
    SickApplyOperate sickApplyOperate;
    ...
    public void doOperate_test() throws Exception{
        ...
        sickApplyOperate.doOperate(1L,applyDO.getStartDate(),applyDO.getEndDate(),"haha");
    }
    @Test
    public void doOperate_Exception()throws Exception{
        ...
        for(int i = 0 ; i <= 30 ; i++){
            ...
            try{
                sickApplyOperate.doOperate(userDO_P.getUserId(),applyDO_P.getStartDate(),applyDO_P.getEndDate(),"haha");
