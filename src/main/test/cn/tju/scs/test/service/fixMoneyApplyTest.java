...
public class fixMoneyApplyTest {
    @InjectMocks
    ...
    UserDAO userDAO;
    @Mock
    FixMoneyApplyOperator fixMoneyApplyOperator;
    ...
    public void doOperate_test() throws Exception{
        ...
        for(int i = 0 ; i <= 30 ; i++){
            ...
            fixMoneyApplyOperator.doOperate(userDO_P.getUserId(),applyDO_P.getStartDate(),applyDO_P.getEndDate(),"haha");
        }
    }
}
