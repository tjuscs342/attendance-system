...
import cn.tju.scs.service.impl.WithMaternityOperator;
...
public class withMaternityApplyTest {
    @InjectMocks
    ...
    UserDAO userDAO;
    @Mock
    WithMaternityOperator withMaternityOperator;
    ...
    public void doOperate_test() throws Exception{
        ...
        withMaternityOperator.doOperate(1L,applyDO.getStartDate(),applyDO.getEndDate(),"haha");
    }
    @Test
    public void doOperate_Exception()throws Exception{
        ...
        for(int i = 0 ; i <= 30 ; i++){
            ...
            try{
                withMaternityOperator.doOperate(userDO_P.getUserId(),applyDO_P.getStartDate(),applyDO_P.getEndDate(),"haha");
            }catch (BLLException e){
                System.out.println(e.getErrorCode());
                Assertions.assertThat(e.getErrorCode()).isEqualTo(ErrorConstantColletion.ApplyRuleException.WMApply_TOO_MUCH.getErrorCode());
                return;
            }
        }
