...
import cn.tju.scs.service.impl.OverTimeApplyOperator;
...
public class overTimeApplyTest {
    @InjectMocks
    ...
    UserDAO userDAO;
    @Mock
    OverTimeApplyOperator overTimeApplyOperator;
    ...
    public void doOperate_test() throws Exception{
        ...
        for(int i = 0 ; i <= 30 ; i++){
            ...
            overTimeApplyOperator.doOperate(userDO_P.getUserId(),applyDO_P.getStartDate(),applyDO_P.getEndDate(),"haha");
        }
    }
}
