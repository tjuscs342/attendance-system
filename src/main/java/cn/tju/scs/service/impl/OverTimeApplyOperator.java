 ...
 */
@Service("overTimeApplyOperator")
public class OverTimeApplyOperator implements AuditOperate,ApplyOperate{
    @Resource
    ...
    public void doOperate(Long userId, Date startDate, Date endDate, String reason) throws BLLException {
        applyManager.applyByType(userId, startDate, endDate, ApplyTypes.Apply_OverTime, reason);
    }
}
